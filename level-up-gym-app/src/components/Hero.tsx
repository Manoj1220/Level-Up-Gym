...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-t from-surface via-surface/80 to-surface/40 pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 text-center flex flex-col items-center mt-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8 relative z-20">
            <Link 
              href="/join"
              className="bg-surface-tint text-surface font-display text-xl px-12 py-4 rounded uppercase hover:scale-105 transition-all neon-glow-strong tracking-widest inline-block"
            >
              Start Journey
            </Link>
            <Link 
              href="/join"
              className="bg-transparent border-2 border-surface-tint text-surface-tint font-display text-xl px-12 py-4 rounded uppercase hover:bg-surface-tint/10 transition-all tracking-widest backdrop-blur-sm inline-block"
            >
              Book Free Trial
            </Link>
          </div>
